...
public class SetDistanceCommand extends FastBridgerCommand {

    private Main main;

    public SetDistanceCommand(Main main) {
        this.main = main;
    }
    ...
    public void executeAs(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (main.getFiles().getArenasConfig().contains(arena)) {
            try {
                int setDistance = Integer.parseInt(distance);

                main.getFiles().getArenasConfig().set(arena + ".distance", setDistance);
                ...
                player.sendMessage("You have successfully set the distance on the arena called " + arena + " to " + distance);
